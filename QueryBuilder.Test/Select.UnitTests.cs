...
namespace QueryBuilder.UnitTests
{
    ...
    public class QuerySelectTest
    {
        ...
        public void CanRetrieveSelectedAliases()
        {
            ...
            Assert.IsFalse(expectedAliases.Where(a => !query1.GetSelectedAliases().Contains(a)).Any());
            ...
            Assert.IsFalse(expectedAliases.Where(a => !query2.GetSelectedAliases().Contains(a)).Any());
            ...
            Assert.IsFalse(expectedAliases.Where(a => !query3.GetSelectedAliases().Contains(a)).Any());

            var query4 = QueryBuilder
                .From<Building>();
            expectedAliases = new List<string> { "building" };
            Assert.IsFalse(expectedAliases.Where(a => !query4.GetSelectedAliases().Contains(a)).Any());

            var query5 = QueryBuilder
                .From<Building>()
                .Top(1);
            expectedAliases = new List<string> { "building" };
            Assert.IsFalse(expectedAliases.Where(a => !query5.GetSelectedAliases().Contains(a)).Any());

            var query6 = QueryBuilder
                .From<Building>()
                .Count();
            expectedAliases = new List<string> { };
            Assert.IsFalse(expectedAliases.Where(a => !query6.GetSelectedAliases().Contains(a)).Any());
        }
