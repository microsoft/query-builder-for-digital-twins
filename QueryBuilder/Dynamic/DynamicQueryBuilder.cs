...
namespace Microsoft.DigitalWorkplace.DigitalTwins.QueryBuilder.Dynamic
{
    ...
    public static class DynamicQueryBuilder
    {
        ...
        public static FilteredQuery<DefaultNonJoinQuery<WhereRelationshipsStatement>, WhereRelationshipsStatement> FromRelationships(string alias = DefaultRelationshipAlias)
        {
            var fromClause = new FromClause
            {
                Alias = alias
